...
>
  Onchainbets Official Banner
        ...
        >
          ...
          <div
            className="absolute inset-0 bg-[url('/images/onchainbet-4.png')] bg-cover bg-center opacity-60"
            aria-hidden="true"
          ></div>
          <div className="absolute inset-0 bg-gradient-to-b from-black via-transparent to-black"></div>
                  ...
                  icon: (
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5l-7 7-4-4"
                      />
                    </svg>
                  ),
                  title: 'No Middlemen',
...
<div className="mt-16 text-center">
  ...
  <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
    Explore our platform, docs, and community.
  </p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-5xl mx-auto">
    ...
    <a
      ...
      className="flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-emerald-500/25 border border-green-400/30"
    >
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.5 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-8.5l-3-3z" />
      </svg>
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium rounded-xl hover:from-green-600 hover:to-emerald-700 border border-gray-600"
    >
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-blue-500/25"
    >
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all duration-300 shadow-lg border border-gray-600"
    >
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all duration-300 shadow-lg col-span-1 sm:col-span-2"
    >
...
>
  {/* Subtle animated background — minimal */}
  ...
  <div className="max-w-6xl mx-auto relative z-10">
    {/* Section Header — clean, centered, bold */}
    ...
    {/* Cards Grid — clean, balanced, elegant */}
              ...
              <div className="col-span-2">
                ...
                >
                  <Image
                    ...
                    className="rounded-lg"
                  />
                  <span className="text-xl font-bold">Onchainbets</span>
                </motion.div>
